...
readonly MAINNET_VERSION="avail-light-client-v1.12.2"
readonly TURING_VERSION="avail-light-client-v1.12.2"
readonly LOCAL_VERSION="avail-light-client-v1.12.2"
